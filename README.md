...
This application is a tracker for sportsmen.
...
Приложение представляет собой простой в использовании, но функциональный фитнес трекер. 
Позволяет узнать:
